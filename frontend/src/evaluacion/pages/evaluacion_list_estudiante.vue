...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 flex items-center justify-center px-4">
          ...
          <div v-else class="text-center space-y-6">
            ...
            <div class="inline-flex items-center justify-center">
              <div class="relative">
                ...
                <div class="relative bg-gradient-to-r from-emerald-600 to-emerald-700 px-8 py-4 rounded-2xl border border-emerald-400/30">
                  <div class="flex items-center gap-3">
                    ...
                    <span class="text-2xl font-bold text-white">Estudiante</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mt-8 rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-6 border border-white/5">
              <div class="flex items-start gap-4">
                ...
                <div class="text-left">
                  <h3 class="text-lg font-semibold text-white mb-1">Vista de Estudiante</h3>
                  <p class="text-sm text-slate-400">
                    Has iniciado sesión como estudiante. Aquí podrás ver y completar las evaluaciones asignadas por tus docentes.
                  </p>
                </div>
              </div>
            </div>
