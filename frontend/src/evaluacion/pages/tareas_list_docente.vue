...
onMounted(async () => {
  try {
    ...
    // Obtener evaluaciones y tareas del curso
    ...
    evaluaciones.value = evaluacionesData as Evaluacion[]
    tareas.value = tareasData as Tarea[]
  } catch (error) {
...
function verDetallesEvaluacion(evaluacion: Evaluacion) {
  // TODO: Implementar vista de detalles de la evaluación
  console.log('Ver detalles de evaluación:', evaluacion.id)
  // router.push({ name: 'evaluacion-detalles', params: { id: evaluacion.id } })
}

function editarEvaluacion(evaluacion: Evaluacion) {
  // TODO: Implementar edición de evaluación
  console.log('Editar evaluación:', evaluacion.id)
  // router.push({ name: 'evaluacion-editar', params: { id: evaluacion.id } })
}

function verDetallesTarea(tarea: Tarea) {
  // TODO: Implementar vista de detalles de la tarea
  console.log('Ver detalles de tarea:', tarea.id)
  // router.push({ name: 'tarea-detalles', params: { id: tarea.id } })
}
                      ...
                      <div class="flex-grow">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                          ...
                          <div class="flex items-center gap-2 text-sm text-slate-400">
                            ...
                            <span>Creada: {{ formatDate(tarea.fecha_registro) }}</span>
                          </div>
                        </div>
                      </div>
